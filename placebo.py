...
class Placebo:
    ...
    def new_puzzle(self, round_name: str, puzzle_name: str,
        ...
        self.google.add_row(round_name, puzzle_name, 'M', puzzle_url, doc_url,
                            channel_name)
...
def main():
    p = Placebo()
    p.new_puzzle('Fear', 'Reuven Testing', 'http://www.example.com/reuven_testing')

    # p.new_round('Reuven Testing', 'http://www.example.com/reuven_testing')

    # p.solved_puzzle('Reuven Testing', 'HOORAY')
